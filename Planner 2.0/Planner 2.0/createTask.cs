        ...
        public GroupBox getTask(string title, string info, DateTime start, DateTime end, bool pinned)
        {
            ...
            switch (Properties.Settings.Default.Theme)
            {
                ...
                case "grey":
                    ...
                    break;
                case "pink": //
                    bar.Style = MetroFramework.MetroColorStyle.Pink;
                    break;
                case "red":
                    bar.Style = MetroFramework.MetroColorStyle.Red;
                    break;
                case "yellow":
                    bar.Style = MetroFramework.MetroColorStyle.Yellow;
                    break;
                case "purple":
                    bar.Style = MetroFramework.MetroColorStyle.Purple;
                    break;
                default:
                    bar.Style = MetroFramework.MetroColorStyle.Blue;
                    break;
