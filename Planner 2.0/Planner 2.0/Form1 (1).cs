...
namespace Planner_2._0
{
    public partial class Planner : Form
    {
        ...
        public const int versionNumber = 209; // current version
        ...
        #region recent stuff
        //recent stuff
        private string RecentRootDir = @"C:\Planner2.0";
        ...
        private void Planner_Load(object sender, EventArgs e) //what to do on start
        {
            ...
            TaskCount.Text = "(" + startTimerDates.Count.ToString() + ")";
            //reset
        ...
        public void setTheme()
        {
            ...
            switch (theme)
            {
                case "blue":
                    ...
                    Darktoggle.Style = MetroFramework.MetroColorStyle.Blue;
                    ...
                    metroTile6.Style = MetroFramework.MetroColorStyle.Blue;
                    metroTile7.Style = MetroFramework.MetroColorStyle.Blue;
                    metroTile8.Style = MetroFramework.MetroColorStyle.Blue;
                    #endregion
                    break;
                case "orange":
                    themeC = Color.FromArgb(243, 119, 53);
                    metroTabControl1.Style = MetroFramework.MetroColorStyle.Orange;
                    Darktoggle.Style = MetroFramework.MetroColorStyle.Orange;
                    metroToggle1.Style = MetroFramework.MetroColorStyle.Orange;
                    metroCheckBox1.Style = MetroFramework.MetroColorStyle.Orange;
                    metroCheckBox2.Style = MetroFramework.MetroColorStyle.Orange;
                    metroCheckBox3.Style = MetroFramework.MetroColorStyle.Orange;
                    metroCheckBox4.Style = MetroFramework.MetroColorStyle.Orange;
                    metroRadioButton1.Style = MetroFramework.MetroColorStyle.Orange;
                    metroRadioButton2.Style = MetroFramework.MetroColorStyle.Orange;
                    metroComboBox1.Style = MetroFramework.MetroColorStyle.Orange;

                    #region tile styles
                    metroTile5.Style = MetroFramework.MetroColorStyle.Orange;
                    metroTile6.Style = MetroFramework.MetroColorStyle.Orange;
                    metroTile7.Style = MetroFramework.MetroColorStyle.Orange;
                ...
                case "green":
                    ...
                    Darktoggle.Style = MetroFramework.MetroColorStyle.Green;
                    metroCheckBox1.Style = MetroFramework.MetroColorStyle.Green;
                    metroCheckBox2.Style = MetroFramework.MetroColorStyle.Green;
                    metroCheckBox3.Style = MetroFramework.MetroColorStyle.Green;
                    metroCheckBox4.Style = MetroFramework.MetroColorStyle.Green;
                    metroRadioButton1.Style = MetroFramework.MetroColorStyle.Green;
                    metroRadioButton2.Style = MetroFramework.MetroColorStyle.Green;
                ...
                case "grey":
                    ...
                    Darktoggle.Style = MetroFramework.MetroColorStyle.Silver;
                    metroToggle1.Style = MetroFramework.MetroColorStyle.Silver;
                    metroCheckBox1.Style = MetroFramework.MetroColorStyle.Silver;
                    metroCheckBox2.Style = MetroFramework.MetroColorStyle.Silver;
                    metroCheckBox3.Style = MetroFramework.MetroColorStyle.Silver;
                    metroCheckBox4.Style = MetroFramework.MetroColorStyle.Silver;
                    metroRadioButton1.Style = MetroFramework.MetroColorStyle.Silver;
                    metroRadioButton2.Style = MetroFramework.MetroColorStyle.Silver;
        ...
        void loadRecents() //loads all recents
        {
            ...
            //FormListNames = RH.getNames().ToList();
            //FormListDir = RH.getdirectory().ToList();
            /*
            for (int i = 0; i < RH.getNames().Length; i++)
            {
                FormListNames.Add(RH.getNames()[i]);
                FormListDir.Add(RH.getdirectory()[i]);
        ...
        void save() //this function handles saving: save as *
        {
            ...
            if (saveFile.ShowDialog() == DialogResult.OK) //pressed ok
            {
                ...
                {
                    string names = System.IO.Path.GetFileName(saveFile.FileName);
                    ...
                    ProjectTitle = names;
                    SL = new SaveLoad(startSave, endSave, ProjectTitle, TaskTitleArray, TaskInfoArray, pinnedarray); //serialize
                    ...
                    stream = File.Open(newName, FileMode.Create);
        ...
        {
            metroTile1.Size = new Size(160, 160);
        }

        private void metroTile1_MouseLeave(object sender, EventArgs e)
        {
            metroTile1.Size = new Size(150, 150);
        }
        ...
        private void button15_Click(object sender, EventArgs e) //ok or save
        {
            ...
            Properties.Settings.Default.SplashScreen = metroCheckBox3.Checked;
            ...
            notifyIcon1.ShowBalloonTip(1000, "Changes made!", "Changes may occur after this program reboots", ToolTipIcon.None);
        }
