...
namespace Planner_2._0
{
    class GetNews
    {
        ...
        public List<string> getInfo()
        {
            ...
            string html = WC.DownloadString("https://planner-site-news.herokuapp.com/");
        ...
        public string getFile()
        {
            WebClient WC = new WebClient();
            string html = WC.DownloadString("https://planner-site-news.herokuapp.com/");
            MatchCollection m1 = Regex.Matches(html, "<p id=\"h.p_cbjR6_OelQAA\" class=\"zfr3Q\">\\s*(.+?)\\s*</p>", RegexOptions.Singleline);
            foreach (Match m in m1)
            {
